...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        dh1, dw2, db2 = affine_backward(dout, cache_out)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers-1):
          ...
          h_prev, cache = affine_relu_forward(h_prev, W, b)
          caches.append(cache)
        scores, cache_out = affine_forward(h_prev, 
        ...
        for i in range(self.num_layers-1,-1,-1):# 2,1,0
          # if it's the last layer, call affine_backward instead of the ReLU 
          if i == self.num_layers-1:
            dh, dw, db = affine_backward(dout, caches[i])
          else: 
